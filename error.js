/**
    Custom HipperChat error
    Inspiration: http://www.devthought.com/2011/12/22/a-string-is-not-an-error/

    Examples:
        new HipperChatError('Error Message');
        new HipperChatError('Error Message', err);
...
*/
function HipperChatError(msg, original) {
  var key;
  ...
  this.name = 'HipperChatError',
  this.message = msg;
}
HipperChatError.prototype.__proto__ = Error.prototype;

module.exports = HipperChatError;